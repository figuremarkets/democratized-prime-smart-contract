...
| `liquidation_access` | **OwnerOnly** (default) or **Permissionless**. Who may call **Liquidate**. Set at instantiate or **UpdateContractConfig**. Rejected if last-known would exceed 1 hour. Paused still blocks Liquidate for everyone. |
