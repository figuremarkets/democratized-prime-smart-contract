...
| `liquidation_access` | **OwnerOnly** (default) or **Permissionless**. Who may call **Liquidate**. Set at instantiate or **UpdateContractConfig**. Permissionless requires last-known ≤ 1 hour, **immediate** haircut, and `deficit_underlying == 0`. Paused still blocks Liquidate for everyone. |
